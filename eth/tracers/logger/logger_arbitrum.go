...
func (*AccessListTracer) CaptureArbitrumTransientStorageGet(key common.Hash, depth int, before bool) {
}
func (*JSONLogger) CaptureArbitrumTransientStorageGet(key common.Hash, depth int, before bool)   {}
func (*StructLogger) CaptureArbitrumTransientStorageGet(key common.Hash, depth int, before bool) {}
func (*mdLogger) CaptureArbitrumTransientStorageGet(key common.Hash, depth int, before bool)     {}

func (*AccessListTracer) CaptureArbitrumTransientStorageSet(key, value common.Hash, depth int, before bool) {
}
func (*JSONLogger) CaptureArbitrumTransientStorageSet(key, value common.Hash, depth int, before bool) {
}
func (*StructLogger) CaptureArbitrumTransientStorageSet(key, value common.Hash, depth int, before bool) {
}
func (*mdLogger) CaptureArbitrumTransientStorageSet(key, value common.Hash, depth int, before bool) {}
